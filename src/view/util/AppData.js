...
export const tableCellOptionsData = [
    ...
    { "value": "13", "text": "副标题" }];
export const JOB_TICKETS_STATUS = [{ value: 1, text: "待签发" }, { value: 2, text: "待接票" }, { value: 3, text: "待完结" }, { value: 4, text: "完结" }]
export const SUB_JOB_TICKETS_STATUS = [{ value: 1, text: "待安措" }, { value: 2, text: "待作业单位审核" }, { value: 3, text: "待安全部门审核" }, { value: 4, text: "待分管副总批准" }, { value: 5, text: "待完结" }, { value: 6, text: "完结" }]
